				...
				<div class="header-body">
					<div class="row align-items-center py-4">
						...
						<div class="col-lg-6 col-5 text-right">
							<a href="/addUserForm" class="btn btn-sm btn-neutral">New</a>
						</div>
					</div>
				</div>
			</div>
							...
							<table class="table align-items-center table-flush">
								<thead class="thead-light">
									<tr>
										...
										<th scope="col" class="sort" data-sort="budget">First
											Name</th>
								...
								<c:forEach var="user" items="${users}">
									...
									<c:url var="editLink" value="/editUserForm">
										<c:param name="userId" value="${user.id }"></c:param>
									</c:url>
									<c:url var="userDeviceLink" value="/userDevice">
										<c:param name="userId" value="${user.id }"></c:param>
									</c:url>
									<tbody class="list">
										<tr>
											<td class="budget">${user.id}</td>

											<td class="budget">${user.firstName}</td>

											<td class="budget">${user.lastName}</td>
											<td class="budget">${user.email}</td>

											<td class="text-right">
											<a class="btn btn-outline-info" href="${userDeviceLink}">Show Devices</a>
												<div class="dropdown">
