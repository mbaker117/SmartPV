...
<title>Real Time Reading Page</title>
<!-- Favicon -->
				...
				<div class="header-body">
					<div class="row align-items-center py-4">
						<div class="col-lg-6 col-7">
							<h6 class="h2 text-white d-inline-block mb-0">Real Time Reading </h6>
				...
				<div class="col">
					<div class="card">
						...
						<div class="card-header border-0">
							<h3 class="mb-0">Real Time Reading</h3>
						</div>
						<!-- Light table -->
							...
							<table class="table align-items-center table-flush">
								<thead class="thead-light">
									<tr>
										...
										<th scope="col" class="sort" data-sort="budget">Temperature</th>
										<th scope="col" class="sort" data-sort="status">Humidity</th>
										<th scope="col" class="sort" data-sort="status">Output</th>
								...
								<c:forEach var="reading" items="${readings}">
									...
									<tbody class="list">
										<tr>
											<td class="budget">${reading.id}</td>

											<td class="budget">${reading.tempreture}C</td>

											<td class="budget">${reading.humidity}%</td>
												<td class="budget">${reading.output}</td>
											<td class="budget">${reading.date}</td>
											<td class="budget">${reading.time}</td>
