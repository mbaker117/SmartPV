...
<title>Expected Reading Page</title>
<!-- Favicon -->
				...
				<div class="header-body">
					<div class="row align-items-center py-4">
						<div class="col-lg-6 col-7">
							<h6 class="h2 text-white d-inline-block mb-0">Expected Reading </h6>
				...
				<div class="col">
					<div class="card">
						...
						<div class="card-header border-0">
							<h3 class="mb-0">Expected Reading</h3>
						</div>
						<!-- Light table -->
							...
							<table class="table align-items-center table-flush">
								<thead class="thead-light">
									<tr>
										...
										<th scope="col" class="sort" data-sort="status">Expected Energy</th>
										<th scope="col" class="sort" data-sort="status">Actual Energy</th>
								...
								<c:forEach var="reading" items="${readings}">
									...
									<tbody class="list">
										<tr>
											...
											<td class="budget">${reading.expected}</td>
											<td class="budget">${reading.energy}</td>
