				...
				<div class="header-body">
					<div class="row align-items-center py-4">
						...
						<div class="col-lg-6 col-5 text-right">
							<a href="/addDeviceForm" class="btn btn-sm btn-neutral">New</a>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="table-responsive">
							<table class="table align-items-center table-flush">
								...
								<c:forEach var="device" items="${devices}">
									...
									<c:url var="realTimeReadingsLink" value="/deviceRealTimeReading">
										<c:param name="deviceId" value="${device.id }"></c:param>
									</c:url>
										<c:url var="expectedReadingsLink" value="/deviceExpectedReading">
										<c:param name="deviceId" value="${device.id }"></c:param>
									</c:url>
									<tbody class="list">
										<tr>
											...
											<i class="bg-success"></i> <span class="status">Activated</span></c:when>
											<c:otherwise>
											<i class="bg-danger"></i> <span class="status">Deactivated</span>
											</c:otherwise>
											</c:choose>
											</span></td>
											...
											<td class="text-right">
												<a class="btn btn-outline-info" href="${realTimeReadingsLink}">Show Real Time Readings</a>
												<a class="btn btn-outline-danger" href="${expectedReadingsLink}">Show Expected Readings</a>
												<div class="dropdown">
													...
													<div
														...
														<a class="dropdown-item" href="${editLink}">Edit</a> <a
															class="dropdown-item" href="${deleteLink }">Delete</a>
